...
-(void)allocUI
{
    _lbTitle = [SBLabel getWithFrame:CGRectMake(0, 5, SCREEN_WIDTH, 20) text:@"4月保费(元)" textColor:UIColorFromRGB(0x999999) textFont:Font_Title15 textAlignment:NSTextAlignmentCenter];
